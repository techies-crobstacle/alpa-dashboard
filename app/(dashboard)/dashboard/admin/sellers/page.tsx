...
//             Manage seller accounts and requests.
//           </p>
//         </div>
//       </div>
...
//                                       Account Name:{" "}
//                                       {seller.bankDetails.accountName}, Account
//                                       Number: {seller.bankDetails.accountNumber}
//                                       , BSB: {seller.bankDetails.bsb}
//                                     </div>
//                                   )}
//                                 </div>
...
//                                     variant="secondary"
//                                   >
//                                     <Flag className="h-4 w-4 mr-1" /> Activate
//                                     Seller
//                                   </Button>
//                                   <Button
//                                     onClick={() =>
//                                       handleCulturalApproval(seller.id)
//                                     }
//                                     variant="outline"
//                                   >
//                                     <Globe className="h-4 w-4 mr-1" /> Cultural
//                                     Approval
//                                   </Button>
...
//                                         <XIcon className="h-4 w-4 mr-1" /> Reject Seller
//                                       </Button>
//                                     </>
//                                   )}
//                                   {seller.status !== "ACTIVE" && (
...
//                                     <Button onClick={() => handleCulturalApproval(seller.sellerId)} variant="outline">
//                                       <Globe className="h-4 w-4 mr-1" /> Cultural Approval
//                                     </Button>
//                                   )}
//                                   {/* Product Live Approval button example */}
//                                   {seller.status === "ACTIVE" && (
...
//                             <TableRow key={seller.id + "-expanded"}>
//                               <TableCell colSpan={5} className="bg-muted/40">
//                                 {/* ...existing code for expanded details and actions... */}
//                               </TableCell>
//                             </TableRow>
//                           )}
//                         </>
